...
const MyRequests = () => {
    ...
    }, [myRequests, searchTerm, selectedBloodGroup, selectedStatus, selectedLocation, dateFilter, sortBy, sortOrder]);
    ...
    const uniqueLocations = [...new Set(myRequests.map(request => request.recipientDistrict))];
